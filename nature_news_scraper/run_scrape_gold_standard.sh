...
#### this file is used to run the initial "benchmark" scrapes
...
# setup result files
JSON_LINK_FILE="${DIR}/../data/benchmark_data/links.json"
JSON_OUT_FILE="${DIR}/../data/benchmark_data/links_crawled.json"
