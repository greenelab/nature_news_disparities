...
if(RERUN_BOOTSTRAP){
    ...
    full_quote_df = subset(full_quote_df, year < 2021)
    quote_prop_df = subset(quote_prop_df, year < 2021)
    quote_prop_boot = subset(quote_prop_boot, year < 2021)
    type_df = subset(type_df, year < 2021)
    career_df = subset(career_df, year < 2021)
    springer_first_prop_df = subset(springer_first_prop_df, year < 2021)
    springer_first_prop_boot = subset(springer_first_prop_boot, year < 2021)
    springer_last_prop_df = subset(springer_last_prop_df, year < 2021)
    springer_last_prop_boot = subset(springer_last_prop_boot, year < 2021)
    nature_first_prop_df = subset(nature_first_prop_df, year < 2021)
    nature_first_prop_boot = subset(nature_first_prop_boot, year < 2021)
    nature_last_prop_df = subset(nature_last_prop_df, year < 2021)
    nature_last_prop_df = subset(nature_last_prop_df, year < 2021)
    first_cited_prop_df = subset(first_cited_prop_df, year < 2021)
    first_cited_prop_boot = subset(first_cited_prop_boot, year < 2021)
