...
```{r echo=F, fig.width=15}
    ...
    ## plot per year stats
    ggplot(eval_df, aes(x=as.factor(year), fill=true_country)) +
        geom_bar(position="dodge") + theme_bw() + 
        xlab("Year of Article") + 
        ylab("Number of Articles (10/year) with \n at least one Country Mention") +
        ggtitle("Country Mention by Year")

    ggplot(eval_df, aes(x=as.factor(year), fill=true_un_subregion)) +
        geom_bar(position="dodge") + theme_bw() + 
        xlab("Year of Article") + 
        ylab("Number of Articles (10/year) with \n at least one UN Subregion Mention") +
        ggtitle("Subregion Mention by Year")
    
    ggplot(eval_df, aes(x=as.factor(year), fill=true_un_region)) +
        geom_bar(position="dodge") + theme_bw() + 
        xlab("Year of Article") + 
