...
top_un_subregions = top_un_subregions$country
mentioned_df = get_aggr_region(country_df,
                               num_art_df, 
                               curr_corpus = "nature_news", 
                               aggr_col_id = "country")

mentioned_df = subset(mentioned_df, country %in% top_un_subregions)

cited_df = get_aggr_region(country_df,
                               num_art_df, 
                               curr_corpus = "news_citation", 
                               aggr_col_id = "country")

cited_df = subset(cited_df, country %in% top_un_subregions)
...
```{r qc_num_article_foreground, out.width="50%", echo=FALSE, warning=FALSE, message=F}
