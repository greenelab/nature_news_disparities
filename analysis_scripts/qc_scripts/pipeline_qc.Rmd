...
colnames(num_quotes)[3] = "num_quotes"

num_quotes$pipeline_step = "p4"
num_quotes = rbind(num_quotes, 
                article_stats_step3_df[,colnames(num_quotes)])
p4_quotes = ggplot(num_quotes, aes(x=year, y=num_quotes, fill=pipeline_step)) +
    geom_boxplot() + theme_bw() + 
    xlab("Year of Article") + ylab("# quotes") +
        ggtitle("number of quotes per article over time pipeline step 4")
...
colnames(sum_length_quotes)[3] = "sum_length_quotes"
sum_length_quotes$pipeline_step = "p4"
sum_length_quotes = rbind(sum_length_quotes, 
                article_stats_step3_df[,colnames(sum_length_quotes)])
p4_sum_quotes = ggplot(sum_length_quotes, aes(x=year, y=sum_length_quotes, fill=pipeline_step)) +
    geom_boxplot() + theme_bw() + 
    xlab("Year of Article") + ylab("sum length quotes") +
        ggtitle("summed length of quotes per article over time pipeline step 4")
...
p4_males = ggplot(num_males, aes(x=year, y=num_males, fill=pipeline_step)) +
    geom_boxplot() + theme_bw() + 
    xlab("Year of Article") + ylab("# male quotes") +
    ggtitle("number of male quotes per article over time pipeline step 4")


# num females
num_females = gender_summary(quote_stats_df, "FEMALE", "num_females", 
                           article_stats_step3_df)
p4_females = ggplot(num_females, aes(x=year, y=num_females, fill=pipeline_step)) +
    geom_boxplot() + theme_bw() + 
    xlab("Year of Article") + ylab("# female quotes") +
    ggtitle("number of female quotes per article over time pipeline step 4")


# num unknown
num_unknown = gender_summary(quote_stats_df, "UNKNOWN", "num_unknown", 
                           article_stats_step3_df)
p4_unknown = ggplot(num_unknown, aes(x=year, y=num_unknown, fill=pipeline_step)) +
    geom_boxplot() + theme_bw() + 
    xlab("Year of Article") + ylab("# female quotes") +
    ggtitle("number of unknown gender quotes per article over time pipeline step 4")
